...
const createMetadata = async(walletCtx, mint, name, symbol, description, imgBuffer, imgFile, websiteLink, twitterLink, tgLink, mintAuthority, updateAuthority, aiImageUrl) => {
    ...
    // Pass aiImageUrl to uploadMetadata if imgFile is null (fetch failed)
    const {imageUrl, metadataUri} = await uploadMetadata(imgFile, metadata, aiImageUrl);
...
export const createToken = async(walletCtx, name, ticker, description, imgBuffer, imgFile, websiteLink, twitterLink, tgLink, aiImageUrl) => {
    ...
    try {
        ...
        const {imageUrl, ix: metadataIx} = await createMetadata(walletCtx, 
            mintKeypair.publicKey, 
            name, ticker, description, imgBuffer, imgFile, websiteLink, twitterLink, tgLink, 
            walletCtx.publicKey, /* walletCtx.publicKey */ new PublicKey("J7Mwys8rr2QiUh83uQPTNpropyve5fekWF9eseWm7G62"), aiImageUrl);
